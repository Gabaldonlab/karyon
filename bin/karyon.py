...
if __name__ == '__main__':	
	...
	parser.add_argument('-K', '--keep_tmp', action='store_true', default=False, help='If this tag is active, the program will not remove all temporary files in the folder tmp after it has finished')
	...
	print ("Now I'm cleaning temporary files...")
	if args.keep_tmp == True:
