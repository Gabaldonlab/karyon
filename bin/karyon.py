...
parser.add_argument('-g', '--genome_assembler', default="platanus", choices=['dipspades','dipSPAdes','spades', 'SPAdes','platanus','Platanus', 'soapdenovo', 'SOAPdenovo'], help="Genome assembly software to use. By default it will use dipSPAdes. Options are: dipSPADEs, SPAdes, SOAPdenovo or Platanus.")
...
def main():
	...
	if args.keep_tmp == True:
		existence = open(args.temporary + "/" + job_ID + '/_keep_existing_', 'w')
		existence.close()
